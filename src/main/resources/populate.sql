...
insert into users(first_name,last_name,email,password,salary,active,department_id) values ('admin','admin','ceo@pgs.com','admin123',20000,true,null);
insert into users(first_name,last_name,email,password,salary,active,department_id) values ('damian','krawczyk','damian@pgs.com','user123',2000,true,1);
